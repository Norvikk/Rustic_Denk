...
pub fn run() -> anyhow::Result<String> {
    ...
    let decentralized_chunks = process_decrypt::recentralize::recentralize(&keys_content, 12);
    ...
    bricked_content = process_decrypt::recentralize::recentralize(&bricked_content, 12);
